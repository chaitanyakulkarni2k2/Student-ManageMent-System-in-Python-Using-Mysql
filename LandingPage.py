...
hed = Label(root, text = "Student Management System", bg = "#4361ee",fg="#e9ecef",font="Times 50 underline bold")
# hed = Label(root, text = "Vishwakarma Pvt.Ltd.", bg = "#4361ee",fg="#e9ecef",font="Times 50 underline bold")
#placing the widget on the screen
hed.pack(fill=X)

#student details Heading Configurations 
instruction = Label(root, text = "Name:  Chaitanya Kulkarni",bg = "#7209b7",fg="#ced4da",font="Times 25 bold" , anchor = NW, padx=15, pady=10)

# instruction = Label(root, text = "student Details:",bg = "#7209b7",fg="#ced4da",font="Times 25 bold" , anchor = NW, padx=15, pady=10)
#placing the widget on the screen
instruction.pack(pady=(20,8),padx=100, fill=X) 
fontstyle=tf.Font(family="Times",size= 20, weight= "bold")

#student Details Body Configurations 
