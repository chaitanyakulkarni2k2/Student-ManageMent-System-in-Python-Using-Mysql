...
def create_user_account():
  ...
  # Creating the Account NO Frame
    Account_no_label = Label(base_frame, text="2th Y Marks:",
    ...
    dob_label = Label(base_frame, text="Prn No:",
    ...
    Contact_label = Label(base_frame, text="12th Marks:", bg="#023047",
                        fg="#ced4da", font='Times 30 bold', width=12)
    ...
    Aadhar_label = Label(base_frame, text="3rd Y Marks:",
                        bg="#023047", fg="#ced4da", font='Times 30 bold', width=11)
...
# Creating the Address Frame
    ...
    Address_label = Label(base_frame, text="Ist Y Marks:",
                        bg="#023047", fg="#ced4da", font='Times 30 bold', width=11)
    ...
    Gender_label = Label(base_frame, text="Email:", bg="#023047",
                        fg="#ced4da", font='Times 30 bold', width=12)
    ...
    Account_Type_label = Label(base_frame, text="4th Y Marks:",
                            bg="#023047", fg="#ced4da", font='Times 30 bold', width=11)
